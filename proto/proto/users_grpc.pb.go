...
func (c *usersClient) DeleteUser(ctx context.Context, in *DeleteUserReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedUsersServer) DeleteUser(context.Context, *DeleteUserReq) (*empty.Empty, error) {
